...
export function GridSection() {
  return (
    <Section
      id="grid"
      purpose="Grid lays children out in equal-width columns. Choose one to four columns, or six for a denomination row, a gap step, and optionally fewer columns below the md breakpoint so tiles and cards stay readable on a phone."
      title="Grid"
