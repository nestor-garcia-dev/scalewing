...
Scalewing is a shared design system. Product apps consume `@scalewing/react@0.5.0` or `@scalewing/react-native@0.5.0`. They do not fork the class sheet or invent a second visual system.
...
- Web: `pnpm add @scalewing/react@0.5.0` and `import '@scalewing/react/styles.css'` once.
- Native: `pnpm add @scalewing/react-native@0.5.0`. No CSS class API.
...
- Depend on `@scalewing/react@0.5.0` (web) or `@scalewing/react-native@0.5.0` (native).
